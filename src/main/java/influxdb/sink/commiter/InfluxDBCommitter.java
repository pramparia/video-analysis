 ...
 */
package influxdb.sink.commiter;
...
import static influxdb.sink.InfluxDBSinkOptions.WRITE_DATA_POINT_CHECKPOINT;
import static influxdb.sink.InfluxDBSinkOptions.getInfluxDBClient;
...
public final class InfluxDBCommitter implements Committer<Long> {
     ...
     * InfluxDB. The {@link influxdb.sink.writer.InfluxDBWriter} prepares the
