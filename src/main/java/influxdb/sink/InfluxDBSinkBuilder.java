 ...
 */
package influxdb.sink;


import influxdb.sink.writer.InfluxDBSchemaSerializer;
import org.apache.flink.configuration.Configuration;

import static influxdb.sink.InfluxDBSinkOptions.*;
...
public final class InfluxDBSinkBuilder<IN> {
    ...
    /**
     * Sets the buffer size of the {@link influxdb.sink.writer.InfluxDBWriter}. This also determines the number of {@link
    ...
    private void sanityCheck() {
        ...
        checkNotNull(this.influxDBToken, "The InfluxDB token is required but not provided.");
